...
function* watchDelRequest() {
    yield takeLatest(getAction(actions.TOUR_REQUEST_DEL), delRequested)
}

function* watchGetSingleRequest() {
    yield takeLatest(getAction(actions.TOUR_REQUEST_GET_SINGLE), getSingleRequested)
}

function* watchSaveDataRequest() {
    yield takeLatest(getAction(actions.TOUR_REQUEST_SAVE_DATA), saveDataRequested)
}
