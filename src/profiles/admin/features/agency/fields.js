...
const agencyBasicFormFields = [
    { component: 'input', id: 'socialName', label: 'agencyName', maxLength: 120, name: 'socialName', required: true, type: 'text' },
    {
        component: 'input',
        id: 'cnpj',
        label: 'cnpj',
    ...
    { component: 'input', id: 'nameAdm', label: 'nameAdm', maxLength: 120, name: 'nameAdm', required: true, type: 'text' },
    {
        component: 'input',
        id: 'cpfAdm',
        label: 'cpfAdm',
